...
prerequistes_scripts=("external-repos.bash" "dnf.bash" "firewall.bash" "network.bash" "ntp.bash" "selinux.bash" "usefullcmd.bash" "httpd.bash" "../Database/srv-database/mariadb.bash" "autoupdate.bash" "nagios-nrpe.bash" "webmin.bash" "portal.bash")
case $g_server in
